...
void main() {
  ...
  // float strength = 0.015 / distance(stretchUv, vec2(0.5));

  // Pattern 31
  // vec2 stretchUvX = vec2(vUv.x * 0.1 + 0.45, vUv.y * 0.5 + 0.25);
  // float lightX = 0.015 / distance(stretchUvX, vec2(0.5));

  // vec2 stretchUvY = vec2(vUv.x * 0.5 + 0.25, vUv.y * 0.1 + 0.45);
  // float lightY = 0.015 / distance(stretchUvY, vec2(0.5));

  // float strength = lightX * lightY;
  
  // Pattern 32
  // vec2 rotatedUv = rotate(vUv, PI * 0.25, vec2(0.5));
  // vec2 stretchUvX = vec2(rotatedUv.x * 0.1 + 0.45, rotatedUv.y * 0.5 + 0.25);
  // float lightX = 0.015 / distance(stretchUvX, vec2(0.5));

  // vec2 stretchUvY = vec2(rotatedUv.x * 0.5 + 0.25, rotatedUv.y * 0.1 + 0.45);
  // float lightY = 0.015 / distance(stretchUvY, vec2(0.5));
